...
# TEST_AGENT_ID = "test-sim-agent-001" # Original hardcoded ID
# TEMPORARY DEBUGGING STEP: Use the ID observed in Ops-Core logs from the last run
# This ID is generated by AgentKit and might change. This is just to get past the initial polling failure.
TEST_AGENT_ID = "39a97542-985f-4a8a-89f4-ede564f64573"
