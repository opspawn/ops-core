...
class OpsCoreUser(HttpUser):
    """
    Locust user class for Scenario 4: Stress Test.
    Uses the same mixed load pattern as Scenario 3 but is intended
    to be run with incrementally increasing user counts until failure.
    """
    # Default wait time - can be adjusted if needed for stress test
    ...
    def register_with_opscore(self):
        ...
        registration_payload = {
            ...
            "agent_details": {
                ...
                "metadata": {"load_test_user": self.agent_id, "scenario": 4}
            }
        }
    ...
    @task(80) # Weight from Scenario 3
    ...
    @task(15) # Weight from Scenario 3
